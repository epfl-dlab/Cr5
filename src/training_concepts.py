# python training_concepts.py --voc_size 200000 --min_lang 2 --lower_threshold 100 --upper_threshold 700 --lang_codes en_it
...
parser.add_argument("--lang_codes", type=str, default=None, help="Required. String that represents the languages you want to embed. Ex. en_de_es_vi_da")
...
training_concepts_id = '{}_{}_lt_{}_ut_{}_ml_{}'.format( '_'.join(lang_codes), words_considered, lower_threshold, upper_threshold, min_lang)
